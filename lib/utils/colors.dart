...
const Color mobileBackgroundColor = Color.fromARGB(255, 75, 75, 75);
const Color blueColor = Color.fromRGBO(10, 81, 161, 1.0);
...
Color greyColor = const Color.fromRGBO(152, 152, 152, 1.0);
